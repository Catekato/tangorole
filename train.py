...
def parse_args():
    ...
    parser.add_argument(
        "--train_file", type=str, default="/Users/yuyingxia/Downloads/tango/data/train_audiocaps.json",
        help="A csv or a json file containing the training data."
    )
    parser.add_argument(
        "--validation_file", type=str, default="/Users/yuyingxia/Downloads/tango/data/valid_audiocaps.json",
        help="A csv or a json file containing the validation data."
    )
    parser.add_argument(
        "--test_file", type=str, default="/Users/yuyingxia/Downloads/tango/data/test_audiocaps_subset.json",
    ...
    parser.add_argument(
        "--text_encoder_name", type=str, default="bert-based-uncased",
